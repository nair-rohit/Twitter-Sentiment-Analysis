...
def sentimentAnalysis():
    ...
    kstream = KafkaUtils.createStream(ssc, 'localhost:2181', 'spark-streaming', {'rohittry7':1})
    ...
    corona_es_write_conf = {
        "es.nodes": "localhost",
        "es.port": "9200",
        "es.resource": 'coronatw/test-corona-doc',
        "es.input.json": "yes",
    ...
    trump_es_write_conf = {
        "es.nodes": "localhost",
        "es.port": "9200",
        "es.resource": 'trumptw/test-trump-doc',
        "es.input.json": "yes",
        "es.mapping.id": "doc_id"
    }
